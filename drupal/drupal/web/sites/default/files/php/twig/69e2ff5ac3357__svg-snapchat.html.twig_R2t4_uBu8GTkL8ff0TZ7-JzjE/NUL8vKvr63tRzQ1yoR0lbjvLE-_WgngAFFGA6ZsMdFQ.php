...
/* @solo/partials/svg/_svg-snapchat.html.twig */
class __TwigTemplate_a0a926a178a3abaea8229bda18effccc extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<svg class=\"svg-icon snapchat\" height=\"100%\" version=\"1.1\" viewBox=\"0 0 512 512\" width=\"100%\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:serif=\"http://www.serif.com/\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><path class=\"path-update\" style=\"stroke:none;fill-rule:evenodd;fill:";
        (((($context["sm_icon_colors"] ?? null) == "")) ? (yield "--solo-sn") : (yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["sm_icon_colors"] ?? null), "html", null, true)));
...
";
    ...
    {
        return "@solo/partials/svg/_svg-snapchat.html.twig";
    }
    ...
    {
        return new Source("", "@solo/partials/svg/_svg-snapchat.html.twig", "/opt/drupal/web/themes/contrib/solo/partials/svg/_svg-snapchat.html.twig");
    }
