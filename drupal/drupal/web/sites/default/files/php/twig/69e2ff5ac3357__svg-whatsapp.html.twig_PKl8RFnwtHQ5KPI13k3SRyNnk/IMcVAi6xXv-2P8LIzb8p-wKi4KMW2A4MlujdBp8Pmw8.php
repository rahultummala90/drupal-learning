...
class __TwigTemplate_9edfae5555d18365e5bc218b9a6975d3 extends Template
{
  ...
  <g>
    <path class=\"path-update\" style=\"stroke:none;fill-rule:evenodd;fill:";
        // line 3
        (((($context["sm_icon_colors"] ?? null) == "")) ? (yield "--solo-up") : (yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["sm_icon_colors"] ?? null), "html", null, true)));
...
";
    ...
    {
        return new Source("", "@solo/partials/svg/_svg-whatsapp.html.twig", "/opt/drupal/web/themes/contrib/solo/partials/svg/_svg-whatsapp.html.twig");
    }
