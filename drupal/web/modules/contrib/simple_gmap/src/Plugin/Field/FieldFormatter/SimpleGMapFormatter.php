...
#[FieldFormatter(
  id: 'simple_gmap',
  label: new TranslatableMarkup('Google Map from one-line address'),
  field_types: [
    'string',
    'string_long',
    'computed',
...
class SimpleGMapFormatter extends FormatterBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state): array {
    ...
    $elements['alt_text'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Alt text for embedded map'),
      '#required' => TRUE,
      '#default_value' => $this->getSetting('alt_text'),
      '#description' => $this->t("Alt text needed for accessibility reasons. %address will be replaced by the address value."),
    ];
    return $elements;
  }
  ...
  public function settingsSummary(): array {
    ...
    $summary[] = $this->t('Alt text: @alt', ['@alt' => $this->getSetting('alt_text')]);
  ...
  public function viewElements(FieldItemListInterface $items, $langcode): array {
    ...
    foreach ($items as $delta => $item) {
      ...
      $element[$delta] = [
        ...
        '#include_text' => $settings['include_text'],
        '#iframe_width' => ['#plain_text' => $settings['iframe_width']],
        '#iframe_height' => ['#plain_text' => $settings['iframe_height']],
        ...
        '#alt_text' => str_replace('%address', $address, $settings['alt_text']),
      ];
    }
